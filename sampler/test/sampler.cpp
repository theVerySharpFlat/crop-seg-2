...
TEST(SamplerTest, IndexTest) {
  ...
  //   //           << std::format("{:064b},{:064b},{:064b}", lower, middle,
  //   upper)
  //   //           << std::endl;
  //   //
  //
  ...
  //         //           << std::endl;
  //         //
  //         // for (size_t j = info.cache->nCols - 8 * 2; j < info.cache->nCols
  //         + 8;
  //         //      j++) {
  ...
  //
  //         // if (i > 1024) {
  //         //   for (size_t j = sampleIndex / 8 - 1 * 8; j < sampleIndex / 8 +
  //         8;
  //         //   j++) {
  //         //     std::cout << std::format(" {:08b} ",
  //         info.cache->bitrange[j]);
  //         //   }
  //         //   std::cout << std::endl;
  //         //
